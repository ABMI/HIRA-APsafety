...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (797617,21604712,715939,21604718,755695,21604711,739138,21604714,722031,21604713)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (797617,21604712,715939,21604718,755695,21604711,739138,21604714,722031,21604713)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (750982,21604741,717607,21604751,715259,21604749,743670,21604745,725131,21604740,710062,21604696,738156,21604699,778268,21604689,721724,21604697,21604693)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (750982,21604741,717607,21604751,715259,21604749,743670,21604745,725131,21604740,710062,21604696,738156,21604699,778268,21604689,721724,21604697,21604693)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (436073,436665)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (436073,436665)
  and c.invalid_reason is null
...
FROM (
	...
	JOIN #Codesets cs on cs.codeset_id = 30 AND de.drug_concept_id = cs.concept_id
	...
	FROM @cdm_database_schema.DRUG_EXPOSURE de
	JOIN ctePersons p on de.person_id = p.person_id
	JOIN #Codesets cs on cs.codeset_id = 30 AND de.drug_source_concept_id = cs.concept_id
) E
;
