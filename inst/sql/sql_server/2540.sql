...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (757627,733523,701322,715997)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (757627,733523,701322,715997)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (766529,735979,785788,766814,800878,703244,19057607,712615,757688,794852)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (766529,735979,785788,766814,800878,703244,19057607,712615,757688,794852)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (705944,40843492,42943600,42943598,42943576,21119719,42943580,42943592,42943584,42943588,40843487,42943578,40236419,42943601,42943585,21080489,42943590,742185,742226,742227,742228,19098491,742230,742266,1398937,40227886,42707371,40169601)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (705944,40843492,42943600,42943598,42943576,21119719,42943580,42943592,42943584,42943588,40843487,42943578,40236419,42943601,42943585,21080489,42943590,742185,742226,742227,742228,19098491,742230,742266,1398937,40227886,42707371,40169601)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (742185,21600398,21604762,705944,21604757,1398937)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (742185,21600398,21604762,705944,21604757,1398937)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (438409,4047120)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (438409,4047120)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (705944,21604757)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (705944,21604757)
  and c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (751246,21604555)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (751246,21604555)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (742185,21600398,21604762)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (742185,21600398,21604762)
  and c.invalid_reason is null
...
WHERE (YEAR(C.drug_exposure_start_date) - P.year_of_birth >= 10 and YEAR(C.drug_exposure_start_date) - P.year_of_birth <= 19)
AND C.ordinal = 1
...
JOIN 
(
  select ENDS.person_id, min(drug_exposure_start_date) as era_start_date, DATEADD(day,365, ENDS.era_end_date) as era_end_date
  from
  (
