...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (435783,4286201,4335169,434010,432590,35207135,37117049)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (435783,4286201,4335169,434010,432590,35207135,37117049)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42922209,42921820,42925694,42925693,40833326,36224240)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (42922209,42921820,42925694,42925693,40833326,36224240)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (757688)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (757688)
  and c.invalid_reason is null
...
WHERE (YEAR(C.drug_exposure_start_date) - P.year_of_birth >= 18 and YEAR(C.drug_exposure_start_date) - P.year_of_birth <= 65)
AND C.ordinal = 1
...
FROM (
	...
	FROM @cdm_database_schema.DRUG_EXPOSURE de
	JOIN ctePersons p on de.person_id = p.person_id
	JOIN #Codesets cs on cs.codeset_id = 15 AND de.drug_source_concept_id = cs.concept_id
) E
;
